...
if (session == null || session.getAttribute("email") == null) {
    ...
    return;
        ...
        try
        {
            ...
            PreparedStatement psmt = con.prepareStatement("delete from admin where trim(email) = ?");
            psmt.setString(1, req.getParameter("d_email"));
            ...
            if(b == false)
            {
               resp.setContentType("text/html");
                out.println("<h2 style='color: green; text-align: center;'><b>Your Admin Deleted Succesfully...</b></h2>");
                ...
                RequestDispatcher rd2 = req.getRequestDispatcher("delete_admin.html");
                rd2.include(req, resp);
            }
