...
public class Remove_Room extends HttpServlet
{
...
if (session == null || session.getAttribute("email") == null) {
    ...
    return;
        ...
        try
        {
            ...
            PreparedStatement psmt = con.prepareStatement("delete from rooms where roomnumber = ?");
            ...
            if(b == false)
            {
                ...
                out.println("<h2 style='color:red' align='center'>Room "+r_number+" Removed Successfully </h2>");
