...
<html lang="en">
    ...
    <head>
        ...
        <title>Velvet Vista Hotel - Update Employee</title>
        <style>
            /* General Reset */
            * {
                margin: 0;
        ...
        <!--<link rel="stylesheet" href="style_update_employee.css">-->
    </head>
            ...
            <section>
                <div class="form-container">
                    ...
                    <%
                        ...
                        String salary = (String) session.getAttribute("u_salary");
                        String job = (String) session.getAttribute("u_job");
                    ...
                    <form action="Update_Employee" method="post">
                        ...
                        <div>
                            <label for="u_job">Job Role</label>
                            <input type="text" id="u_job" name="u_job" value="<%= job%>" required>
                        </div>

                        <div>
                            <label for="u_salary">Salary</label>
                            <input type="number" id="u_salary" name="u_salary" value="<%= salary%>" required>
                        </div>
                        ...
                        <input type="submit" value="Update Employee" class="submit-button">
                    </form>
                </div>
            </section>
